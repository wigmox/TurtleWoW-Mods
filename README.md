...
- [➡️➡️STEP 1 - START HERE⬅️⬅️](#step-1-start-here)
  ...
  - [VanillaFixes aka Game Launcher](#vanillafixes-aka-game-launcher)
    - [Option 1 - VanillaFixes (Normal Version)](#option-1---vanillafixes-normal-version)
    - [Option 2 - VanillaFixes (DXVK Version)](#option-2---vanillafixes-dxvk-version)
  - [Editing dlls.txt - Last Step](#editing-dlls-txt-last-step)
...
- [⭐Turtle WoW HD Graphics, Textures, and Mods⭐](#turtle-wow-hd-graphics-textures-and-mods)
  ...
  - [💥HD Texture Mods💥](#hd-texture-mods)
  - [Appletrey's CLASSIC HD Patch - Updated Items, Buildings, Structures, Weapons, and Armor](#appletrey-s-classic-hd-patch-updated-items-buildings-structures-weapons-and-armor)
...
- [🆘🆘 Troubleshooting / FAQ 🆘🆘](#troubleshooting-faq)
  - [The Video Settings Don't Show My Resolution or Max Resolution is 1600x1200](#the-video-settings-don-t-show-my-resolution-or-max-resolution-is-1600x1200)
...
2. The game files should all be unzipped into a folder that is easy to find such as <br>
...
5. ⚡⚡ **Reboot** after installing the Redistributable updates ⚡⚡
...
> [!Note]
> <b>What is the WDB folder and why do this?</b>
>
...
<details>
<summary>The steps below will prevent the WDB folder from ever being created.</summary>
>
...
1. Download [vanilla-tweaks_v2 zip](https://github.com/tubtubs/vanilla-tweaks/releases/download/tag/vanilla-tweaks_tag_x86_64-pc-windows-gnu.zip)
...
<details>
<summary>Option 3 OLD/OUTDATED - [LAUNCHER] - Apply Using The Launcher (EASY)</summary>

<br>Option 3 is irrelevant for now since CapyWoW does not have a launcher at the moment. This is just a placeholder for when/if Capy does release a launcher.
...
[New Vanilla Tweaks - Additional improvements and does not conflict with SuperWoW](https://github.com/tubtubs/vanilla-tweaks)

[Original Vanilla Tweaks - Beware can overlap and conflict with SuperWoW settings!!!](https://github.com/brndd/vanilla-tweaks)
...
3. [Download SuperAPI](https://github.com/balakethelock/SuperAPI/archive/refs/heads/master.zip) - The SuperWoW configuration addon which will add a minimap icon allowing you to change SuperWoW settings.
...
The Nampower repo was turned off no longer exists. [Nampower Wayback Archive](https://web.archive.org/web/20260527113405/https://gitea.com/avitasia/nampower)

1. Download the [nampower.dll](https://github.com/RetroCro/TurtleWoW-Mods/raw/refs/heads/main/Archive/DLL%20BACKUP/nampower.dll)
2. Put nampower.dll in your main CapyWoW/TWoW folder.
3. Download the [NampowerSettings Addon](https://raw.githubusercontent.com/RetroCro/TurtleWoW-Mods/refs/heads/main/Archive/DLL%20BACKUP/NampowerSettings.zip) so you can edit Nampower settings. This will add a minimap icon allowing you to change various Nampower settings.
...
[Nampower](https://gitea.com/avitasia/nampower) - Repo gone! Use the [wayback archived view](https://web.archive.org/web/20260527113405/https://gitea.com/avitasia/nampower) if you want to read it.
...
1. Download the latest [UnitXP_SP3 zip](https://raw.githubusercontent.com/RetroCro/TurtleWoW-Mods/refs/heads/main/Archive/DLL%20BACKUP/UnitXP_SP3%20v87.zip).
...
[UnitXP_SP3 Wayback Archive](https://web.archive.org/web/20260619050428/https://codeberg.org/konaka/UnitXP_SP3)
...
> # ⚠ Warning ⚠
>
> Some people have reported issues/errors trying to use dxvk with the latest Nvidia 5000 series cards and AMD GPU's!
...
> If nothing happens when you run VanillaFixes then try removing or renaming d3d9.dll and run VanillaFixes again. If it works without d3d9 then you're PC is not compatible with DXVK but that's ok.
...
1. Download the [latest perf_boost.dll](https://raw.githubusercontent.com/RetroCro/TurtleWoW-Mods/refs/heads/main/Archive/DLL%20BACKUP/perf_boost.dll).
...
4. Download the latest [Perf_Boost settings addon](https://raw.githubusercontent.com/RetroCro/TurtleWoW-Mods/refs/heads/main/Archive/DLL%20BACKUP/perfboostsettings.zip).
...
1. Download [no1600x1200.dll](https://raw.githubusercontent.com/RetroCro/TurtleWoW-Mods/refs/heads/main/Archive/DLL%20BACKUP/no1600x1200.dll).
...
<details>
<summary>OLD/OUTDATED - Enable MPQ Mods using the Launcher</summary>
...
[Project Reforged](https://projectreforged.github.io/vanilla/downloads/turtle/)
...
[Project Reforged Homepage](https://projectreforged.github.io/vanilla/)
...
[Download vanilla-autologin](https://github.com/paokkerkir/vanilla-autologin/archive/refs/heads/main.zip)

[vanilla-autologin](https://github.com/paokkerkir/vanilla-autologin)

</details>

<details>
<summary>🗝️ OLD/OUTDATED DO NOT USE - Option 2 - Basic OG Version~~</summary>
...
3. Download the modified DXVK that enables bigger mouse cursor - [d3d9.dll](https://raw.githubusercontent.com/RetroCro/TurtleWoW-Mods/refs/heads/main/Archive/d3d9.dll)
...
6. Here is a sample [DXVK.conf with bigger cursor setting](https://raw.githubusercontent.com/RetroCro/TurtleWoW-Mods/refs/heads/main/Archive/dxvk.conf).
7. Save the conf.dxvk file > Start CapyWoW/Turtle WoW

[Wiki Page for Bigger Cursors](https://turtle-wow.fandom.com/wiki/Client_Mods#Bigger_mouse_cursor)
...
Post all the relevant info to the [CapyWoW English Community Discord](https://discord.gg/dK6qZGGSu):
...
See [earlier section about no1600x1200](#no1600x1200).
...
<details>
<summary>Common Fixes and Things to Try...</summary>
...
<summary>config.wtf settings to improve frames</summary>
